...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/frontend/assets/css/base.css')}}">
    <link rel="stylesheet" href="{{asset('public/frontend/vendors/css/grid.css')}}">
    <link rel="stylesheet" href="{{asset('public/frontend/assets/css/main.css')}}">
    <link rel="stylesheet" href="{{asset('public/frontend/assets/css/cart.css')}}">
    <link rel="stylesheet" href="{{asset('public/frontend/assets/css/product_details.css')}}">
    <link rel="stylesheet" href="{{asset('public/frontend/assets/css/responsive.css')}}">
    <link rel="stylesheet" href="{{asset('public/frontend/assets/css/carousel_pddt.css')}}">
    <link rel="stylesheet" href="{{asset('public/frontend/assets/css/checkout.css')}}">

    <script src="{{asset('public/frontend/assets/js/carousel_pddt.js')}}"></script>
    <script src="{{asset('public/frontend/assets/js/main.js')}}"></script>
    <script src="{{asset('public/frontend/assets/js/cart.js')}}"></script>
    <script src="{{asset('https://kit.fontawesome.com/bf8f778c02.js')}}" crossorigin="anonymous"></script>
                            ...
                            <div class="header_with_search-main">
                                <div class="header_search_left">
                                    ...
                                    <div class="col-md-2 checkout" style="margin-left: -50px;">
                                        ...
                                        if ($customer_id != null) {
                                        ?>
                                            <a href="{{ URL::to('/checkout') }}" class="header_cart-history" id="">
                                                Thanh toán
                                            </a>
                                        <?php
                                        } else {
            ...
            <div class="hidden_on_mobile header_navbar_bottom grid wide">
                <ul class="header_navbar_list">
                    ...
                    <li class="header_navbar_item">
                        ...
                        <a href="{{URL::to('/danh-muc-san-pham/'.$cate->category_id)}}" class="header_navbar_link"> {{($cate->category_name)}}</a>
                    </li>
                    ...
                    <li class="header_navbar_item header_navbar_acctive">
                        ...
                        <div class="header_navbar_accessory">
                            <div class="header_accessory-item-group">
                                ...
                                <ul class="header_accessory_list">
                                    <li class="header_accessory_item">
                                        <a href="{{URL::to('/tintuc-sanphammoi')}}" class="header_accessory_link">Sản phẩm mới</a>
                                    </li>
                                    <li class="header_accessory_item">
                                        <a href="{{URL::to('/tintuc-congnghe')}}" class="header_accessory_link">Công nghệ</a>
                                    </li>
                            ...
                            <div id="carousel_bartop" class="carousel slide carousel_bartop" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active carousel_bartop_item">
                                        <a href="#">
                                            <img src="{{asset('public/frontend/assets/images/830-300-830x300-6.png')}}" style="margin: 15px 32px;" width="725px" height="345px" alt="Photos">
                                        </a>
                                    </div>
                                    <div class="carousel-item carousel_bartop_item">
                                        <a href="#">
                                            <img src="{{asset('public/frontend/assets/images/830-300-830x300-8.png')}}" style="margin: 15px 32px;" width="725px" height="345px" alt="Photos">
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="col l-4 c-0" style="margin-top: 20px;">
                                ...
                                <ul class="bar_list">
                                    <li class="bar_item">
                                        <a href="#" class="bar_link">
                                            <img src="{{asset('public/frontend/assets/images/laptopdesk(3)-340x340.jpg')}}" width="220%" height="184px" alt="Photos" style="border-radius: 15px;">
                                        </a>
                                    </li>
                            ...
                            <div class="row">
                                <ul class="bar_list">
                                    <li class="bar_item">
                                        <a href="#" class="bar_link">
                                            <img src="{{asset('public/frontend/assets/images/laptopdesk-340x340.jpg')}}" width="220%" height="184px" alt="Photos" style="border-radius: 15px;">
                                        </a>
                                    </li>

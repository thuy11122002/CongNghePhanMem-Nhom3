            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <form action="{{ URL::to('/tim-kiem-manageorder-inventory') }}" class="header_search" method="post">
                                {{csrf_field()}}
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{URL::to('/view-order-inventory/'.$ord->order_code)}}" class="edit" title="View" data-toggle="tooltip"><i class="fa-solid fa-eye"></i></a>

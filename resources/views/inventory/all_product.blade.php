            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                        <form action="{{ URL::to('/tim-kiem-product-inventory') }}" class="header_search" method="post">
                                {{csrf_field()}}
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <!-- Cột 1 -->
                            <form style="" action="{{URL::to('/tim-kiem-nang-cao-product-inventory')}}" method="post">
                                {{csrf_field()}}
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{URL::to('/edit-product-inventory/'.$pro->product_id)}}" class="edit" title="Edit" data-toggle="tooltip"><i class="fa-solid fa-pen-to-square"></i></a>
                                    <a onclick="return confirm('Bạn có chắc muốn xóa sản phẩm này không?')" href="{{URL::to('/delete-product-inventory/'.$pro->product_id)}}" class="delete" title="Delete" data-toggle="tooltip"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach

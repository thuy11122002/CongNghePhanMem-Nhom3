            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <form action="{{ URL::to('/tim-kiem-report-inventory') }}" class="header_search" method="post">
                                {{csrf_field()}}
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <!-- Cột 1 -->
                            <form style="" action="{{URL::to('/tim-kiem-nang-cao-report-inventory')}}" method="post">
                                {{csrf_field()}}
                    ...
                    <table class="table table-striped table-hover table-bordered">
                        ...
                        <tbody>
                            @foreach($search_all_report as $key => $pro)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button style="width: 40px; height: 33px" class="edit_qty_in_report_inventory btn btn-primary" title="Add" data-toggle="tooltip" data-product-id="{{$pro->product_id}}" data-product-qty="{{$pro->product_qty}}">

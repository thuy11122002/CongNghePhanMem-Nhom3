    ...
    <script>
        $(document).ready(function() {
            $('.order_details_inventory').change(function() {
                ...
                if (j == 0) {
                    $.ajax({
                        url: "<?php echo e(url('/update-order-quantity-inventory')); ?>",
                        type: 'POST',
                        data: {
                            _token: _token,
        ...
        $(document).ready(function() {
            ...
            $('.update_quantity_order_inventory').click(function() {
                ...
                $.ajax({
                    url: "<?php echo e(url('/update-qty-inventory')); ?>",
                    type: 'POST',
                    data: {
                        _token: _token,
                        order_product_id: order_product_id,
...
// Nhập thêm số lượng sản phẩm vào trong kho - chức năng nhập kho
        $(document).ready(function() {
                $('.edit_qty_in_report_inventory').click(function(e) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('/import-product-qty-inventory')); ?>",
                        type: 'POST',
                        data: {
                        ...
                        success: function(response) {
                            ...
                            window.location.href = "<?php echo e(url('report-inventory')); ?>";
                        },
            ...
            $(document).ready(function() {
                $('.edit_qty_in_report_inventory_all').click(function(e) {
                    ...
                    $.ajax({
                        url: "<?php echo e(url('/import-product-qty-inventory-all')); ?>",
                        type: 'POST',
                        data: {
                            product_id: productId,
                            product_qty_import: qtyToAdd,
                        ...
                        success: function(response) {
                            ...
                            // Redirect to report page
                            alert('Đã cập nhật số lượng thành công!');
                            window.location.href = "<?php echo e(url('report-add-inventory')); ?>";
                        },
                        error: function(jqXHR, textStatus, errorThrown) {
                            // Handle error response here
                        }
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="background-image: linear-gradient(180deg,#7c9d37 10%,#ec4588 100%);">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(URL::to('/dashboard-inven')); ?>">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo e(URL::to('/dashboard-inven')); ?>">
            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo e(URL::to('/add-category-product-inventory')); ?>">Thêm danh mục</a>
                        <a class="collapse-item" href="<?php echo e(URL::to('/all-category-product-inventory')); ?>">Liệt kê danh mục</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Tùy chọn:</h6>
                        <a class="collapse-item" href="<?php echo e(URL::to('/add-brand-product-inventory')); ?>">Thêm thương hiệu</a>
                        <a class="collapse-item" href="<?php echo e(URL::to('/all-brand-product-inventory')); ?>">Liệt kê thương hiệu</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Tùy chọn:</h6>
                        <a class="collapse-item" href="<?php echo e(URL::to('/add-product-inventory')); ?>">Thêm sản phẩm</a>
                        <a class="collapse-item" href="<?php echo e(URL::to('/all-product-inventory')); ?>">Liệt kê sản phẩm</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
            ...
            <li class="nav-item">
                ...
                <div id="collapseOrder" class="collapse" aria-labelledby="headingOrder" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Tùy chọn:</h6>
                        <a class="collapse-item" href="<?php echo e(URL::to('/manage-order-inventory')); ?>">Xuất đơn hàng</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseReport" class="collapse" aria-labelledby="headingReport" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Tùy chọn:</h6>
                        <a class="collapse-item" href="<?php echo e(URL::to('/report-inventory')); ?>">Báo cáo tồn & Nhập kho</a>
                        <a class="collapse-item" href="<?php echo e(URL::to('/report-add-inventory')); ?>">Nhập sản phẩm</a>
                    </div>
                </div>
            </li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="<?php echo e(URL::to('/logout-invent')); ?>">Logout</a>
                </div>
            </div>
        </div>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\shopdienthoailaravel\resources\views//inventory_layout.blade.php ENDPATH**/ ?>
...
<body>
                        ...
                        <tbody>
                            ...
                            <tr class="color_qty_<?php echo e($details->product_id); ?>">
                                ...
                                <td>
                                    ...
                                    <button data-product_id="<?php echo e($details->product_id); ?>" class="update_quantity_order_inventory" name="update_quantity_order" value="">Cập nhật</button>
                                    <?php endif; ?>
                                </td>
    ...
    <div style="margin-right: 50px; float: right">
        <h5>
            <a href="<?php echo e(URL::to('/print-order-inventory/'.$details->order_code)); ?>" style="text-decoration: none;" target="_blank_">In đơn hàng</a>
        </h5>
    </div>
</body>
...
<?php echo $__env->make('inventory_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shopdienthoailaravel\resources\views/inventory/view_order.blade.php ENDPATH**/ ?>
        ...
        <div class="container details">
        	<div class="row">
                <div class="col-xs-5 item-photo">
                    <img style="max-width:100%;" src="<?php echo e(URL::to('/public/uploads/product/'.$value->product_image)); ?>" />
                </div>
                
                <div class="col-xs-7" style="border:0px solid gray">
                    <!-- Datos del vendedor y titulo del producto -->
                    <h3><?php echo e($value->product_name); ?></h3>    
                    <h5 style="color:#337ab7">Thương hiệu: <?php echo e($value->brand_name); ?><a href="#"></a> ·  <style ="color:#337ab7"></style></h5>
                    <h5 style="color:#337ab7">Danh mục: <?php echo e($value->category_name); ?><a href="#"></a> ·  <style ="color:#337ab7"></style></h5>
                    ...
                    <h3 style="margin-top:0px;"><?php echo e(number_format($value->product_price).' '.'VNĐ'); ?></h3>
                    ...
                    <div class="section" style="padding-bottom:10px;">
                        <h5 class="title-attr">Số sản phẩm có sẵn: <?php echo e($value->product_qty); ?></h5>                       
                    </div>   

                    <script>
                        $('form').submit(function(event) {
                            var qty = parseInt($('input[name="qty"]').val()); // Lấy giá trị số lượng sản phẩm người dùng nhập vào
                            var max_qty = <?php echo e($value->product_qty); ?>; // Lấy giá trị số lượng sản phẩm có sẵn từ PHP
                            if (qty > max_qty) {
                ...
                <div class="col-xs-12">
                    ...
                    <div style="width:100%;border-top:1px solid silver; padding: 15px;">
                        <p>
                           ...
                           <?php echo e($value->product_desc); ?>

                            
                        </p>
                            <?php echo e($value->product_content); ?>
        ...
        <div class="container details_on_mobile">
        	<div class="row">
                ...
                <div class="col-xs-12" style="border:0px solid gray; margin-left: 25px">
                    <!-- Datos del vendedor y titulo del producto -->
                    <h3 style="font-size: 17px;"><b><?php echo e($value->product_name); ?></b></h3>    
                    <h5 style="color:#337ab7; font-size: 13px;">Thương hiệu: <?php echo e($value->brand_name); ?><a href="#"></a> ·  <style ="color:#337ab7"></style></h5>
                    <h5 style="color:#337ab7; font-size: 13px;">Danh mục: <?php echo e($value->category_name); ?><a href="#"></a> ·  <style ="color:#337ab7"></style></h5>
                    ...
                    <h3 style="margin-top:0px; font-size: 18px;"><b><?php echo e(number_format($value->product_price).' '.'VNĐ'); ?></b></h3>
...
<link href="<?php echo e(asset('//maxcdn.bootstrapcdn.com/bootstrap/3.3.0/css/bootstrap.min.css')); ?>" rel="stylesheet" id="bootstrap-css">

<script src="<?php echo e(asset('//maxcdn.bootstrapcdn.com/bootstrap/3.3.0/js/bootstrap.min.js')); ?>"></script>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shopdienthoailaravel\resources\views/pages/sanpham/show_details.blade.php ENDPATH**/ ?>
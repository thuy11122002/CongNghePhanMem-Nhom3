      ...
      <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
        ...
        <div class="row tm-edit-product-row justify-content-center">
          <div class="col-xl-6 col-lg-6 col-md-12">
            <form action="<?php echo e(URL::to('/save-product-inventory')); ?>" class="tm-edit-product-form" method="post" enctype="multipart/form-data">
...
<?php echo $__env->make('inventory_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shopdienthoailaravel\resources\views/inventory/add_product.blade.php ENDPATH**/ ?>
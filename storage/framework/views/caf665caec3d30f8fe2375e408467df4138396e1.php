        ...
        <form style="width: 100%;" action="<?php echo e(URL::to('/tim-kiem-nang-cao')); ?>" method="post">
            ...
            <div class="form-group col-xs-6 col-sm-3">
                <select data-filter="make" class="filter-make filter form-control" name="category_submit">
                    <option value="<?php echo e($category_words); ?>"><?php echo e($category_name1); ?></option>
            ...
            <div class="form-group col-xs-6 col-sm-3">
                <select data-filter="model" class="filter-model filter form-control" name="brand_submit">
                    <option value="<?php echo e($brand_words); ?>"><?php echo e($brand_name1); ?></option>
            ...
            <div class="form-group col-xs-6 col-sm-3">
                <select data-filter="price" class="filter-price filter form-control" name="price_submit">
                    <option value="<?php echo e($price_words); ?>"><?php echo e($price_text); ?></option>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shopdienthoailaravel\resources\views/pages/sanpham/avanced_search.blade.php ENDPATH**/ ?>